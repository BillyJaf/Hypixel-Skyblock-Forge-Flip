...
const TimeFilters: React.FC<TimeFilterToggles> = ({
  quickForge,
  setQuickForge,
  coleQuickForge,
  setColeQuickForge,
  ...
  const toggleQuickForge = (
    <FormControlLabel
      control={
        <Switch
          checked={quickForge}
          onClick={() => setQuickForge(!quickForge)}
        />
      }
      label="Apply Quick Forge"
    />
  );
  ...
  const toggleColeQuickForge = (
    <FormControlLabel
      control={
        <Switch
          checked={coleQuickForge}
          onClick={() => setColeQuickForge(!coleQuickForge)}
        />
      }
      label="Apply Cole Quick Forge"
    />
  );
